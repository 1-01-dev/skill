  ...
  factory: (require) => {
    ...
    function installStyle() {
      ...
      style.textContent = [
        ...
        '.dlc-actions{display:flex;gap:8px;flex-wrap:wrap}',
      ...
      return React.createElement('aside', { id: PANEL_ID, className: 'dlc-panel', 'aria-label': 'Workspace Learning' },
        ...
        React.createElement('main', { className: 'dlc-body' },
          React.createElement('div', { className: 'dlc-note' },
            ...
            React.createElement('div', { style: { marginTop: 6, color: 'var(--dsw-alias-label-secondary,#999da7)' } }, 'This panel is attached to the current DSH workspace, not to an individual session.'),
          ),
          React.createElement('div', { className: 'dlc-actions' },
            React.createElement('button', { className: 'dlc-button dlc-primary', type: 'button' }, 'Create chapter'),
            React.createElement('button', { className: 'dlc-button', type: 'button' }, 'Open library'),
          ),
        ),
      )
    }
